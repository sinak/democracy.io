...
export function WhyDio() {
  ...
  useEffect(() => {
    ...
    let playTimer: ReturnType<typeof window.setTimeout> | undefined;

    const observer = new IntersectionObserver(
      ([entry]) => {
        const fullyInView = entry.isIntersecting && entry.intersectionRatio === 1;

        if (fullyInView) {
          if (!videoEntered) {
            container.classList.add('ng-enter');
  ...
  // Add icon-enter class to SVGs when they scroll into view
  useEffect(() => {
    if (!aboutVisible) return;

    const icons = document.querySelectorAll('#about svg[id^="icon-"]');
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add('icon-enter');
          }
        });
      },
      { threshold: 1.0 }
  ...
  const showAbout = useCallback(() => {
    ...
    // Scroll to about-lead section
    setTimeout(() => {
      aboutLeadRef.current?.scrollIntoView({ behavior: 'smooth' });
    }, 100);
  }, []);
    ...
    <div id="whydio">
      <div className="container">
        <div className="row">
          <div
            id="video-container"
            className={`col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2${videoEntered ? ' ng-enter' : ''}`}
          ...
          >
            ...
            <div>
              <img
                ...
                alt=""
              />
              <video id="video" ref={videoRef} controls width="100%">
      ...
      <div id="about-lead" ref={aboutLeadRef}>
        <div className="container">
          <div className="row">
            <div className="col-md-10 col-md-offset-1">
              <h2>
                Democracy thrives when people&rsquo;s voices are heard. The
                easier it is for you to contact Congress, the better. It&rsquo;s
                that simple.
              </h2>
              <div className={`text-center${aboutVisible ? ' ng-hide' : ''}`} id="showAbout">
                <span className="btn btn-lg btn-outline" onClick={showAbout}>
                  Read more <i className="icon-angle-down"></i>
                </span>
              </div>
            </div>
          </div>
      ...
      <div id="about" className={aboutVisible ? 'ng-enter' : 'hidden'}>
          <div className="lead">
            <div className="container">
              <div className="row">
                <div className="col-md-8 col-md-offset-2">
                  <p>
                    ...
                    their constituents&rsquo; views, making it harder for them
                    to represent us in the lawmaking process.
                  </p>
                  <p>
                    That&rsquo;s why we built Democracy.io: a new tool to put
                    you in touch with your members of Congress&mdash;with as few
                    clicks as possible.
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-10 col-md-offset-1">
                ...
                <div className="row">
                    ...
                    >
                      <defs>
                        ...
                        <linearGradient
                          ...
                          id="a"
                        >
                          <stop stopColor="#1BA0FD" offset="0%" />
                          <stop stopColor="#F93468" offset="100%" />
                        </linearGradient>
                        <path
                          id="c"
                  ...
                  <div className="col-md-8 v-center">
                    ...
                    <p>
                      ...
                      message&mdash;not three different messages on three
                      different forms on three different websites.
                    </p>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        specific topic. We let you tell Congress exactly
                ...
                <div className="row">
                  <div className="col-md-8 v-center">
                    <h2>We don&rsquo;t tell people what to say</h2>
                    <p>
                      This project is hosted by the{' '}
                      <a href="https://taskforce.is">Taskforce.is</a>, but
                      it&rsquo;s a neutral tool. We don&rsquo;t control or
                      influence the messages that are sent through Democracy.io.
                      We&rsquo;re committed to free speech, and we support the
                      free speech rights of our users.
                    </p>
                    <p>
                      Sometimes we may oppose what people choose to tell their
                      legislators. Even in those cases, we won&rsquo;t censor
                      what individuals choose to say. We think society benefits
                      from a plurality of voices speaking on a broad range of
                      topics, and as a free speech organization this is a value
                      we hold dear, even if we disagree with the message.
                    </p>
                    <p>
                  ...
                  <div className="col-md-4 hidden-xs hidden-sm v-center">
                    ...
                    >
                      <defs>
                        ...
                        >
                          <stop stopColor="#fff" offset="0%" />
                          <stop stopColor="#E8FCFF" offset="100%" />
                        </linearGradient>
                      </defs>
                ...
                <div className="row">
                    ...
                    >
                      ...
                      <g fill="none">
                        <g
                          ...
                          fill="none"
                        >
                          <path d="M194.395 252.363s80.503-35.757 80.503-125.677c0-89.919-80.503-125.677-80.503-125.677" />
                          <path d="M177.557 222.576s61.547-27.337 61.547-96.083-61.547-96.083-61.547-96.083" />
                          <path d="M159.334 198.674s46.16-20.503 46.16-72.062-46.16-72.062-46.16-72.062" />
                        </g>
                        <g>
                          <g
                            id="Shape"
                            transform="translate(1) translate(0 72.315)"
                          >
                            <use
                              stroke="url(#a3)"
                              strokeWidth="2"
                  ...
                  <div className="col-md-8 v-center">
                    ...
                    <p>
                      ...
                      easy. Then more people will do it. And that&rsquo;s good
                      for democracy.
                    </p>
                    <p>
                      ...
                      we&rsquo;ve been working on a large-scale project to
                      improve how Internet users contact elected officials and
                      other decision makers.
                    </p>
                    <p>
                      Democracy.io lets you test out one of these
                      tools&mdash;emailing members of Congress&mdash;but
                      we&rsquo;re also creating simple ways to send Tweets to
                      members of Congress, call Congress, sign petitions, and
                      submit official comments to government agencies. If
                      you&rsquo;re an advocacy organization that likes how this
                      works, check out our{' '}
                ...
                <div className="row">
                  <div className="col-md-8 v-center">
                    ...
                    <p>
                      ...
                      want to make the world a better place&mdash;
                      ...
                      Foundation. It&rsquo;s maintained by{' '}
                    ...
                    <p>
                      ...
                      <a href="https://twitter.com/legind">
                        William Budington
                      </a>
                      . The{' '}
                      <a href="https://github.com/unitedstates/contact-congress">
                    ...
                    >
                      <defs>
                        <linearGradient
                          ...
                          id="a4"
                        >
                          <stop stopColor="#F85528" offset="0%" />
                          <stop stopColor="#F93468" offset="100%" />
                        </linearGradient>
                      </defs>
                      <g fill="none">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 v-center">
                    ...
                    <p>
                      ...
                      you&rsquo;re a web developer who might want to
                      occasionally volunteer, send an email to{' '}
                    ...
                    <p>
                      We <i className="icon-heart"></i> democracy.
                    </p>
                  </div>
                </div>
              </div>
