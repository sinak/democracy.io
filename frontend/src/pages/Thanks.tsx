const shares = [
  {
    ...
    svg: (
      <svg width="70" height="70" viewBox="0 0 1900 1900" xmlns="http://www.w3.org/2000/svg">
        <path
...
export function Thanks() {
  ...
  return (
    <div className="row">
      <div id="thanks" className="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        <p>Spread the word and ask your friends to write to their representatives too.</p>
        ...
        <div id="share-icons">
          ...
          {shares.map((share) => (
            <div className="col-xs-4" key={share.name}>
              <a
                className="share-link"
                onClick={() => sharePopup(share.link)}
                role="button"
                tabIndex={0}
              >
                {share.svg}
